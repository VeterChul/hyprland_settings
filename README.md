...
reboot
-->
# ZSH — просто откройте новый терминал
```
...
- **Если установили ZSH**: откройте новый терминал и наслаждайтесь кастомной строкой приглашения.  
- **Если тустановили Hyprland**: запустите `Hyprland` из консоли или настройте DM для автоматического входа.
