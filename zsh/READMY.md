...
Я написал тему, которая позволяет достигнуть нужного мне визуала и легко изменять его, если я хочу его. Тема позволяет указать элементы, указать их положение(справа или слева), а так же цвет текста и фона, на котором этот текст написан.
...
НАстроки строки можно менять через указание 
